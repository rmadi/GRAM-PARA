...
SinginComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: SinginComponent, selectors: [["app-singin"]], decls: 25, vars: 2, consts: [[1, "card"], [1, "title"], [1, "subtitle"], ["routerLink", "register", "routerLinkActive", "active"], [1, "or"], [1, "email-login"], [4, "ngIf", "ngIfThen"], ["for", "email"], ["type", "text", "placeholder", "Enter Email", "name", "email", "ngModal", "", "required", "", 3, "change"], ["for", "psw"], ["type", "password", "placeholder", "Enter Password", "name", "pws", "ngModal", "", "required", "", 3, "change"], [1, "cta-btn", 3, "click"], ["alertMe", ""], ["role", "alert", 1, "alert", "alert-danger"]], template: function SinginComponent_Template(rf, ctx) { if (rf & 1) {
